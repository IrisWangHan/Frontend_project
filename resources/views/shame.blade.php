...
<body>
    <div class="detail">
        ...
        <div class="detail-left">
            <img src="./cd/cont/cd-夏夕夏景 (1) (2).jpg" alt="">
        </div>
        ...
        <div class="detail-right">
            <div class="detail-right-left">
                <div class="detail-left-top">
                    <div class="ep1-text">
                        <h2>夏夕夏景</h2>
                        <p>攜手夏沐Melo Moon創作首波主打單曲〈夏夕夏景〉，甜美R&B聲線詮釋出夏日派對的悠然自在，肥美的G-Funk 貝斯聲線貫穿全曲，揉合著西屯純愛組招牌玩世不恭的歌詞，打造出這首散發滿滿夏日陽光熱力的〈夏夕夏景〉，融化寒冷的冬天！</p>
                    </div>
                </div>
                ...
                <div class="detail-right-down">
                    <div class="detail-rbc">
                        ...
                        <audio id="music1" loop>
                            <source src="./音檔片段/夏夕夏景 MMM f_01.wav">
                        </audio>
                    </div>
